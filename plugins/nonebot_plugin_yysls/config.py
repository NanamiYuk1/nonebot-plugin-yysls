...
class YyslsConfig(BaseModel):
    # ========== 公告推送配置 ==========
    yysls_news_url: str = "https://www.yysls.cn/news/index.html"
    ...
    yysls_cdkey_sources: List[str] = Field(
        default_factory=lambda: [
            "https://www.yysls.cn/news/acitivity/",  # 官方活动页
        ]
    )

    # ========== 商城提醒配置 ==========
    yysls_shop_remind_day: int = 1  # 每月几号提醒（默认1号）
    yysls_shop_remind_hour: int = 10  # 提醒时间（24小时制）
